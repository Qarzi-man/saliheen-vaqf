...
export const sources = [
  /* ------------------------- Законодательство РТ ------------------------- */
  {
    ...
    category: 'law',
    title: {
      tg: 'Қонуни Ҷумҳурии Тоҷикистон «О благотворительной деятельности» аз 22.04.2003, №18 (бо таҳрири қонунҳои аз 02.01.2018 №1491 ва аз 24.12.2022 №1940)',
    ...
    note: {
      tg: 'Моддаҳо аз матни русии қонун бо тағйирот (2018, 2022) оварда шудаанд. Нусхаи оммавӣ — дар ICNL (метавонад таҳрири аслӣ бошад); таҳрири ҷориро дар махзани расмии қонунгузории ҶТ санҷед.',
      ru: 'Статьи приведены по русскому тексту закона с изменениями 2018 и 2022 гг. Публичная копия — на ICNL (может отражать базовую редакцию); актуальную редакцию сверяйте в официальной базе законодательства РТ.',
    },
    url: 'https://www.icnl.org/?p=6770',
    alt: {
      label: { tg: 'Махзани қонунгузории ҶТ', ru: 'База законодательства РТ' },
      url: 'https://ncz.tj',
    },
  },
  {
