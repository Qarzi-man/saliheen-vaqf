...
export const site = {
  ...
  /**
   * Логотип. По умолчанию — логотип с официального сайта (если он недоступен, показывается текстовая метка).
   * Чтобы не зависеть от внешнего адреса: положите файл в /public/logo.png и укажите '/logo.png'.
   */
